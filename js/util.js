...
NG.DIFFS = {
  easy: { id: "easy", group: "classic", label: "Beginner", rows: 9, cols: 9, mines: 10, cell: 40 },
  medium: { id: "medium", group: "classic", label: "Intermediate", rows: 16, cols: 16, mines: 40, cell: 26 },
  hard: { id: "hard", group: "classic", label: "Expert", rows: 16, cols: 30, mines: 99, cell: 20 },
  ngEasy: { id: "ngEasy", group: "density", label: "Sparse", rows: 9, cols: 9, mines: 8, cell: 40 },
  ngMedium: { id: "ngMedium", group: "density", label: "Even", rows: 16, cols: 16, mines: 30, cell: 26 },
  ngHard: { id: "ngHard", group: "density", label: "Dense", rows: 16, cols: 30, mines: 75, cell: 20 },
};
...
NG.lessonLabel = function (ls, i) {
  return NG.t("lesson.label", {
    n: i + 1,
    chapter: NG.chapterName(ls.chapter || "level"),
    title: NG.lessonField(ls, "title"),
  });
};
